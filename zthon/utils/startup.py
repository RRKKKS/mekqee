    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                buttons=[(Button.url("SOURCE NEON", "https://t.me/NEON_SOURCE"),)],
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await bot.send_file("@BotFather", "zthon/zilzal/venom.jpg")
            ...
            await bot.send_message("@BotFather", f"- بـوت نيون المسـاعـد ♥️🦾 الخـاص بـ  {bot.me.first_name} ")
            ...
            await bot.send_message("@BotFather", f"انتظر بعض لحظات حتي تظهر لك قائمة الاوامر")
...
zthon = {"@NEON_SOURCE", "@RR_BU", "@RB_RO", "@R_N_B1"}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/NEON_SOURCE.jpg")
