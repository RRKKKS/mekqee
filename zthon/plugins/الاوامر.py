...
async def zed_handler(event):
    ...
    if query.startswith("نيون") and event.query.user_id == zedub.uid:
        ...
        buttons = [[Button.url("سورس نيون  - NEON USERBOT", "https://t.me/SOURCE_NEON"),],[Button.url("التحـديثـات", "https://t.me/Tws_SOURCE_NEON"), Button.url("الفـارات", "https://t.me/SOURCE_NEONe1"),],[Button.url("الشـروحـات¹", "https://t.me/Tws_SOURCE_NEON"),],[Button.url("كــلايــش نيون", "https://t.me/SOURCE_NEONklaesh"),],[Button.url("مطـور السـورس", "https://t.me/R_R_B0"),]]
